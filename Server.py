...
class Server():
    def __init__(self, args):
        ...
        model = GRU_AGCN_TP(node_num=args.num_nodes, horizon=args.horizon, dim_in=args.input_dim, dim_in_dec=args.input_dec_dim, dim_out=args.output_dim, dim_hidden=args.hidden_dim, cheb_k=args.cheb_k, embed_dim=args.hidden_dim, pattern_num = args.pattern_num, pattern_dim = args.pattern_dim, layer=args.layer)
